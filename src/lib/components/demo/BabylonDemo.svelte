		...
		scheduleInit(() => {
			(async () => {
				...
				try {
					...
					sunEmitter.radius = 1; sunEmitter.radiusRange = 0;

					const starsEmitter = new SphereParticleEmitter();
					starsEmitter.radius = 20; starsEmitter.radiusRange = 0;

					surfaceParticles.emitter = coreSphere; surfaceParticles.particleEmitterType = sunEmitter;
					flareParticles.emitter   = coreSphere; flareParticles.particleEmitterType   = sunEmitter;
					coronaParticles.emitter  = coreSphere; coronaParticles.particleEmitterType  = sunEmitter;
					starsParticles.emitter   = stars;      starsParticles.particleEmitterType   = starsEmitter;
					...
					surfaceParticles.minSize = 0.4; surfaceParticles.maxSize = 0.7;

					flareParticles.minScaleX = 0.5; flareParticles.minScaleY = 0.5;
					flareParticles.maxScaleX = 1.0; flareParticles.maxScaleY = 1.0;
					flareParticles.addSizeGradient(0, 0);
					flareParticles.addSizeGradient(1, 1);

					coronaParticles.minScaleX = 0.5; coronaParticles.minScaleY = 0.75;
					coronaParticles.maxScaleX = 1.2; coronaParticles.maxScaleY = 3.0;

					starsParticles.minSize = 0.15; starsParticles.maxSize = 0.3;

					surfaceParticles.minLifeTime = 8;      surfaceParticles.maxLifeTime = 8;
					flareParticles.minLifeTime   = 10;     flareParticles.maxLifeTime   = 10;
					coronaParticles.minLifeTime  = 2;      coronaParticles.maxLifeTime  = 2;
					starsParticles.minLifeTime   = 999999; starsParticles.maxLifeTime   = 999999;
					...
					surfaceParticles.minAngularSpeed = -0.4; surfaceParticles.maxAngularSpeed = 0.4;
					flareParticles.minAngularSpeed   = 0;    flareParticles.maxAngularSpeed   = 0;
					coronaParticles.minAngularSpeed  = 0;    coronaParticles.maxAngularSpeed  = 0;
					starsParticles.minAngularSpeed   = 0;    starsParticles.maxAngularSpeed   = 0;

					surfaceParticles.minEmitPower = 0;     surfaceParticles.maxEmitPower = 0;
					surfaceParticles.updateSpeed  = 0.005;
					flareParticles.minEmitPower   = 0.001; flareParticles.maxEmitPower   = 0.01;
					coronaParticles.minEmitPower  = 0;     coronaParticles.maxEmitPower  = 0;
